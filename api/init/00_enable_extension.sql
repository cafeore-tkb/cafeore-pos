...
-- [1.933ms] [rows:0] CREATE TABLE "item_types" ("id" uuid DEFAULT uuid_generate_v4(),"name" text NOT NULL,"display_name" text NOT NULL,"deleted_at" timestamptz,PRIMARY KEY ("id"))
